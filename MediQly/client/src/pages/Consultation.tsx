...
const Consultation = () => {
  ...
  const fetchDoctors = async () => {
    try {
      ...
      const response = await axios.get("http://localhost:8000/api/doctors/available", {
        params: {
      ...
      const sortedDocs = [...doctorsData].sort((a, b) => {
        switch (sortBy) {
          case "rating":
            return b.averageRating - a.averageRating;
          case "experience":
                ...
                <div className="flex-1">
                    ...
                    {doctor.isVerified && (
                          ...
                          <div>
                            <h3 className="text-sm font-medium text-foreground mb-4">Consultation Options</h3>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                              {(doctor.serviceTiers && doctor.serviceTiers.length > 0
                                ? doctor.serviceTiers
                                : [
                                    { name: "Basic", price: 500, duration: 15 },
                                    { name: "Standard", price: 1000, duration: 30 },
                                    { name: "Premium", price: 1500, duration: 60 },
                                  ]
                              ).map((tier, index) => (
                                <div
                                  key={index}
                          ...
                          <div className="mt-6 p-4 bg-muted/50 rounded-lg">
                            <div className="flex items-center justify-between">
                              <div>
                                <h3 className="font-medium text-foreground">Next Available</h3>
                                <p className="text-sm text-muted-foreground">Today 4PM</p>
                              </div>
                              <div className="text-right">
                                <h3 className="font-medium text-foreground">Response Time</h3>
                                <p className="text-sm text-muted-foreground">30 Miniutes</p>
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-border">
                        <div className="text-sm">
                          <span className="text-muted-foreground">Next Available:</span>
                          <p className="font-medium text-foreground">Today 4PM</p>
                        </div>
                        <div className="text-right">
                          <span className="text-sm text-muted-foreground">Starts from</span>
                          <p className="font-semibold text-foreground">₹499</p>
                        </div>
                      </div>
                    </div>
                  </Card>
